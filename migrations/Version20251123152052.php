 ...
 */
final class Version20251123152052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gift_cards (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', purchased_by_id INT DEFAULT NULL, redeemed_by_id INT DEFAULT NULL, code VARCHAR(50) NOT NULL, initial_balance INT NOT NULL, current_balance INT NOT NULL, currency VARCHAR(3) DEFAULT \'EUR\' NOT NULL, redeemed_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_active TINYINT(1) DEFAULT 1 NOT NULL, message LONGTEXT DEFAULT NULL, recipient_email VARCHAR(255) DEFAULT NULL, recipient_name VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_11EA084677153098 (code), INDEX IDX_11EA084651D43F65 (purchased_by_id), INDEX IDX_11EA08462FBC08BA (redeemed_by_id), INDEX idx_gift_card_code (code), INDEX idx_gift_card_active (is_active), INDEX idx_gift_card_expires (expires_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE oauth_provider (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id INT NOT NULL, provider VARCHAR(50) NOT NULL, provider_user_id VARCHAR(255) NOT NULL, provider_email VARCHAR(255) DEFAULT NULL, provider_name VARCHAR(255) DEFAULT NULL, provider_photo_url VARCHAR(500) DEFAULT NULL, provider_data JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', access_token LONGTEXT DEFAULT NULL, refresh_token LONGTEXT DEFAULT NULL, token_expires_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_B2B8F080A76ED395 (user_id), INDEX idx_provider_user (provider, provider_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE payment (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id INT NOT NULL, booking_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', promo_code_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', gift_card_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', amount_cents INT NOT NULL, currency VARCHAR(3) DEFAULT \'EUR\' NOT NULL, payment_method VARCHAR(50) NOT NULL, status VARCHAR(20) NOT NULL, transaction_id VARCHAR(255) DEFAULT NULL, payment_gateway VARCHAR(50) DEFAULT \'stripe\' NOT NULL, metadata JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', stripe_payment_intent_id VARCHAR(255) DEFAULT NULL, stripe_charge_id VARCHAR(255) DEFAULT NULL, original_amount_cents INT DEFAULT NULL, discount_amount_cents INT DEFAULT NULL, gift_card_amount_cents INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_6D28840DA76ED395 (user_id), UNIQUE INDEX UNIQ_6D28840D3301C60 (booking_id), INDEX IDX_6D28840D2FAE4625 (promo_code_id), INDEX IDX_6D28840D2696A98F (gift_card_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE payout_method (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id INT NOT NULL, type VARCHAR(50) NOT NULL, bank_name VARCHAR(255) DEFAULT NULL, account_last4 VARCHAR(50) DEFAULT NULL, iban VARCHAR(34) DEFAULT NULL, bic VARCHAR(11) DEFAULT NULL, stripe_account_id VARCHAR(255) DEFAULT NULL, stripe_bank_account_id VARCHAR(255) DEFAULT NULL, is_default TINYINT(1) DEFAULT 0 NOT NULL, is_verified TINYINT(1) DEFAULT 1 NOT NULL, metadata JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_BDC3287A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE gift_cards ADD CONSTRAINT FK_11EA084651D43F65 FOREIGN KEY (purchased_by_id) REFERENCES users (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE gift_cards ADD CONSTRAINT FK_11EA08462FBC08BA FOREIGN KEY (redeemed_by_id) REFERENCES users (id) ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE oauth_provider ADD CONSTRAINT FK_B2B8F080A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE payment ADD CONSTRAINT FK_6D28840D2696A98F FOREIGN KEY (gift_card_id) REFERENCES gift_cards (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gift_cards DROP FOREIGN KEY FK_11EA084651D43F65');
        $this->addSql('ALTER TABLE gift_cards DROP FOREIGN KEY FK_11EA08462FBC08BA');
        ...
        $this->addSql('ALTER TABLE oauth_provider DROP FOREIGN KEY FK_B2B8F080A76ED395');
        ...
        $this->addSql('ALTER TABLE payment DROP FOREIGN KEY FK_6D28840D2696A98F');
        ...
        $this->addSql('DROP TABLE gift_cards');
